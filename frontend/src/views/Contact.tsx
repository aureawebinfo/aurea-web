...
export const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // --- LA MAGIA ESTÁ AQUÍ ---
      // Concatenamos el código y el número
      const numeroCompleto = `${formState.countryCode} ${formState.phone}`;

      // Enviamos la variable bajo varios nombres comunes para asegurar 
      // que EmailJS la atrape sin importar cómo se llame en tu plantilla.
      const templateParams = {
        name: formState.name,
        from_name: formState.name,
        email: formState.email,
        from_email: formState.email,
        phone: numeroCompleto,         // Opción 1
        telefono: numeroCompleto,      // Opción 2
        phone_number: numeroCompleto,  // Opción 3
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Cuéntanos sobre tu proyecto. Estamos listos para crear algo
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-10 rounded-3xl relative overflow-hidden group flex flex-col justify-center flex-grow">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="relative">
                  <label className="text-xs text-[#D4AF37] font-bold ml-1 mb-2 block tracking-wide uppercase">
                    NOMBRE COMPLETO
                  </label>
                  <div className="relative">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  {/* Teléfono arreglado visualmente */}
                  <div className="relative">
                    <label className="text-xs text-[#D4AF37] font-bold ml-1 mb-2 block tracking-wide uppercase">
                      TELÉFONO
                    </label>
                    <div className="flex bg-[#0a0a0a] border border-white/10 rounded-xl overflow-hidden focus-within:border-[#D4AF37] focus-within:ring-1 focus-within:ring-[#D4AF37] transition-all">
                      
                      {/* SOLUCIÓN AL CORTE: w-[95px] y px-2 */}
                      <select
                        name="countryCode"
                        value={formState.countryCode}
                        onChange={handleChange}
                        className="w-[95px] flex-shrink-0 bg-transparent text-white border-r border-white/10 py-4 px-2 focus:outline-none cursor-pointer text-sm outline-none"
                      >
                        <option value="+57" className="text-black">CO +57</option>
                        <option value="+1" className="text-black">US +1</option>
                        <option value="+52" className="text-black">MX +52</option>
                        <option value="+34" className="text-black">ES +34</option>
                        <option value="+54" className="text-black">AR +54</option>
                        <option value="+55" className="text-black">BR +55</option>
                        <option value="+51" className="text-black">PE +51</option>
                        <option value="+56" className="text-black">CL +56</option>
                      </select>

                      {/* SOLUCIÓN AL CORTE: flex-1 y min-w-0 */}
                      <div className="relative flex-1 min-w-0">
                        ...
                        <input
                          ...
                          className="w-full h-full bg-transparent py-4 pl-9 pr-4 text-white placeholder-gray-600 focus:outline-none outline-none"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      required
                      className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl py-4 pl-12 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-all resize-none"
                    ></textarea>
                  </div>
                </div>
                    ...
                    {status === "submitting" && (
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="absolute -top-2 -right-1 bg-white p-0.5 rounded border border-black rotate-12">
          ...
          >
            <div className="bg-[#0a0a0a] border border-white/10 p-8 rounded-3xl text-center relative overflow-hidden flex flex-col justify-center flex-grow">
              <div className="flex justify-center mb-8">
                <img
                  src="/logo_aurea.png"
                  alt="Áurea Web Logo"
                  className="w-48 h-auto object-contain hover:scale-105 transition-transform duration-500 drop-shadow-[0_0_15px_rgba(212,175,55,0.2)]"
                />
              </div>
              ...
              <p className="text-gray-400 text-sm mb-8 px-4">
                Si prefieres una respuesta inmediata, nuestro canal de WhatsApp
              ...
              <div className="space-y-4 w-full">
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="group w-full flex items-center gap-4 bg-[#0f1f17] border border-[#1f3a2c] hover:border-[#25D366]/50 text-white p-4 rounded-xl transition-all duration-300"
                >
                  ...
                  <div className="text-left">
                    <span className="block text-[10px] text-emerald-300 font-bold uppercase tracking-wider mb-0.5">
                      Respuesta Rápida
                    </span>
                    <span className="block text-base font-semibold leading-none break-all sm:break-normal">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="group w-full flex items-center gap-4 bg-gradient-to-r from-[#0f172a] to-[#1e293b] border border-[#334155] hover:border-blue-400/50 text-white p-4 rounded-xl transition-all duration-300"
                >
                  ...
                  <div className="text-left">
                    <span className="block text-[10px] text-blue-300 font-bold uppercase tracking-wider mb-0.5">
                      Correo Electrónico
                    </span>
                    <span className="block text-base font-semibold leading-none break-all sm:break-normal">
            ...
            <div className="flex items-center justify-center gap-3 p-4 bg-emerald-900/10 border border-emerald-500/20 rounded-2xl flex-shrink-0">
              ...
              <p className="text-sm text-emerald-400 font-medium">
                <span className="font-bold text-white">En línea.</span> Nuestro
